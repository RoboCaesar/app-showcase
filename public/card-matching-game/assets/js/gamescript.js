...
function flipCard(cardIndex, toWhat) {
    $(".cardimage").eq(cardIndex).delay(500).animate({
        ...
        if(toWhat > 0) {
            $(".cardimage").eq(cardIndex).css("background-image", "url(./card-matching-game/assets/images/cards/"
            + String(toWhat) + ".png)");
        }
        else {
            $(".cardimage").eq(cardIndex).css("background-image", "url(./card-matching-game/assets/images/cardback.png)");            
        }
    });
...
$("#carddisplay").on("click", ".cardimage",function() {
    ...
    if (flipped[thisIndex] == false) {
        ...
        $(this).animate({
            ...
            //$(this).css("background-image", "url(assets/images/ace_of_spades.png)");
            $(".cardimage").eq(thisIndex).css("background-image", "url(./card-matching-game/assets/images/cards/"
